  ...
  const experiences = [
    {
      ...
      description:
        "Contributing to front-end projects, learning and applying modern web technologies. Working with HTML, CSS/SCSS, JavaScript, React and collaborating in an agile development team environment.",
      achievements: [
